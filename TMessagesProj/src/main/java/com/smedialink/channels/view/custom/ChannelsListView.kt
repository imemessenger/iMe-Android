...
import com.smedialink.channels.view.adapter.ChannelsPreviewAdapter
...
class ChannelsListView(context: Context, currentAccount: Int) : LinearLayout(context) {

    private val list = RecyclerListView(context)
    private val adapter = ChannelsPreviewAdapter(currentAccount)
    ...
    fun setContent(items: List<ChannelViewModel>) {
