...
public class DialogGroupEmptyCell extends LinearLayout {

    private TextView emptyTextView1;
    private TextView emptyTextView2;

    public DialogGroupEmptyCell(Context context) {
        super(context);
        ...
        emptyTextView1.setText(LocaleController.getInternalString(R.string.NoFolders));
        ...
        String help = LocaleController.getInternalString(R.string.NoFoldersHelp);
