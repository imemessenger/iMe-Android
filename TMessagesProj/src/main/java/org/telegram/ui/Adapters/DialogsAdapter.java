...
public class DialogsAdapter extends RecyclerListView.SelectionAdapter {
    ...
    public DialogsActivity.Tab getAssociatedTab() {
    ...
    public boolean hasSelectedArchive() {
        for (Long selectedDialog : selectedDialogs) {
            if (DialogObject.isFolderDialogId(selectedDialog)) {
                return true;
            }
        }
        return false;
    ...
    public TLObject getItem(int i) {
        ...
        ArrayList<TLRPC.Dialog> arrayList = DialogsActivity.getDialogsArray(currentAccount, dialogsType, folderId, dialogsListFrozen, associatedTab);
        if (hasHints) {
    ...
    public void onViewAttachedToWindow(RecyclerView.ViewHolder holder) {
        if (holder.itemView instanceof DialogCell) {
            ...
            dialogCell.checkCurrentDialogIndex(dialogsListFrozen, associatedTab);
    ...
    public void notifyItemMoved(int fromPosition, int toPosition) {
        ArrayList<TLRPC.Dialog> dialogs = DialogsActivity.getDialogsArray(currentAccount, dialogsType, folderId, false, associatedTab);
