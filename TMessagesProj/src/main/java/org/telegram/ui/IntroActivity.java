...
public class IntroActivity extends Activity implements NotificationCenter.NotificationCenterDelegate {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titles = new String[]{
                LocaleController.getInternalString(R.string.Page1Title),
                LocaleController.getInternalString(R.string.Page2Title),
                LocaleController.getInternalString(R.string.Page5Title),
                LocaleController.getInternalString(R.string.Page4Title),
                LocaleController.getInternalString(R.string.Page6Title)
        };
        messages = new String[]{
                LocaleController.getInternalString(R.string.Page1Message),
                LocaleController.getInternalString(R.string.Page2Message),
                LocaleController.getInternalString(R.string.Page5Message),
                LocaleController.getInternalString(R.string.Page4Message),
                LocaleController.getInternalString(R.string.Page6Message)
        };
        ...
        textView.setTextColor(ContextCompat.getColor(this,R.color.colorThemeBlue));
