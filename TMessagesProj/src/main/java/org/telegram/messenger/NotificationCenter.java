...
public class NotificationCenter {
    ...
    public static final int botButtonClicked = totalEvents++;   // Клик по кнопке бота
    public static final int botItemClicked = totalEvents++;     // Клик по самому боту
    public static final int botAnswerChosen = totalEvents++;    // Клик по ответу бота
