...
public class LayoutHelper {
    ...
    public static AppBarLayout.LayoutParams createAppBar(int width, int height) {
        return new AppBarLayout.LayoutParams(getSize(width), getSize(height));
    }

    public static CoordinatorLayout.LayoutParams createCoordinator(int width, int height) {
